...
# Источник: документация DeepSeek, «Models & Pricing»
# (https://api-docs.deepseek.com/quick_start/pricing), сверено 10.09.2026:
# CONTEXT LENGTH 1M у всех моделей V4, MAX OUTPUT 384K.
#
# Документация говорит «1M», сервер отвечает точнее. Заведомо переполненный
# запрос (10.09.2026) вернул 400 с текстом: «This model's maximum context
# length is 1048576 tokens. However, you requested 1146719 tokens». Значит
# окно — 2^20 = 1 048 576, а не круглый миллион; константа стоит по факту от
# API, как и требует спецификация дня 8, §3.3.
#
