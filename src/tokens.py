...
class RequestTokens:
    ...
    # Корзина дня 12 — снова в конце и с умолчанием: блок профиля пользователя
    ...
    task: int = 0
    # Корзина дня 14 — в конце и с умолчанием: блок инвариантов уходит в
...
def count_request(
    ...
    messages = (
        ...
        + (1 if task else 0) + (1 if invariants else 0)
    )
